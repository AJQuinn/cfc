...
if nwindows > 1
    cfc_signals  = cfc.util.swsignals(cfc_signals,window_size,window_step);
...
if nperms > 0
    ...
    for idx = 1:nperms
        ...
        surr_signals = cfc.util.basesignals( surr_signal, cfg.sr, ...
            hi_bounds, ...
            lo_bounds, ...
            time_vect, ...
            cfg.true_timecourse );
        ...
        if nwindows > 1
            surr_signals  = cfc.util.swsignals(surr_signals,window_size,window_step);
        end
