...
if strcmp(obj.method,'designfilt')
  [~,h,phi,w] = cfc.filter.generate(512,obj.sample_rate,obj.centre_freq,...
                            obj.pass_width,obj.trans_width);
elseif strcmp(obj.method,'eeglab')
  [~,filtwts] = cfc.filterer.eeglab.eegfilt_silent(randn(1,10240),obj.sample_rate,...
...
[~,h,phi,w] = cfc.filter.generate(512,S.obj.sample_rate,get(H,'value'),...
